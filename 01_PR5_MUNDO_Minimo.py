...
class Grafo:
    ...
    def agregar_arista(self, u, v, tiempo):
        """
        Función para agregar una arista al grafo.
        """
        self.grafo.append([u, v, tiempo])  # Agregar la arista como una lista [u, v, tiempo]
    ...
    def kruskal_mst(self, mst_type='min'):
        """
        ...
        # Ordenar el grafo por tiempo de viaje en orden ascendente o descendente según mst_type
        ...
        while e < self.V - 1:
            u, v, tiempo = self.grafo[i]  # Obtener la arista siguiente del grafo ordenado
            ...
            if x != y:
                ...
                resultado.append([u, v, tiempo])  # Agregar la arista al MST
...
# Agregamos las rutas con sus tiempos de viaje
...
resultado = g.kruskal_mst(mst_type='min')  # Encontrar el Árbol de Mínimo Coste
print("Rutas de transporte público óptimas:")
for u, v, tiempo in resultado:
    print(f"De la estación {u} a la estación {v}, tiempo de viaje: {tiempo} minutos")
